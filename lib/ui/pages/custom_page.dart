...
class _BuildYourOwnPageState extends GameSidePageState<BuildYourOwnPage> {
  ...
  void _addItem() {
    if (_formKey.currentState!.validate()) {
      ...
      GameData newData = GameData.fromUserInput(nameText, summaryText, thingProducedText, thingProducedPluralText, bonusNameText, bonusPluralText, bonusRate, bonusCost, winningPoint, clickers);
